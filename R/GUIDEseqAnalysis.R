GUIDEseqAnalysis <- function(alignment.inputfile, umi.inputfile, 
    alignment.format = "bed", umi.header = FALSE, read.ID.col = 1, 
    umi.col = 2, umi.sep = "\t",
    ...
    0.445, 0.508, 0.613, 0.851, 0.732, 0.828, 0.615,0.804, 0.685, 0.583))
{
    ...
    cat("combine plus and minus peaks ... \n")
    ...
    cat("Please check output file in directory ", outputDir , "\n")
